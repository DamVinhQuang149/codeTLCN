                                        ...
                                        if (couponCode !== '') {
                                            for (var i = 0; i < couponData.length; i++) {
                                                if (couponCode == couponData[i].coupon_code) {
                                                    //console.log('couponCode matched:', couponCode);

                                                    if (couponData[i].coupon_remain > 0) {
                                                        //console.log('coupon_remain > 0:', couponData[i].coupon_remain);

                                                        if (couponData[i].temp_cost >= couponData[i].min_order) {
                                                            //console.log('temp_cost >= min_order:', couponData[i]
                                                            //.temp_cost, couponData[i].min_order);
                                                            ...
                                                            couponResult.innerHTML =
                                                                'Giá trị đơn hàng chưa thỏa điều kiện';
                                                            return;
                                                        }
                                                    } else {
                                                        //console.log('coupon_remain <= 0:', couponData[i].coupon_remain);
                                                    ...
                                                    //console.log('couponCode not matched:', couponCode);
