                                ...
                                <div class="order-products">
                                    ...
                                    <div class="order-col">
                                        <h5><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail"
                                            ...
                                            <?php echo $_SESSION['cart'][$value['id']]?></h5>
                                        <div style="width:60%">
                                            <strong>
                                                <?php echo $value['name'] ?><div></div>
                                    ...
                                    function applyCoupon() {
                                        ...
                                        for (var i = 0; i < couponData.length; i++) {
                                            if (couponCode == couponData[i].coupon_code && couponData[i].coupon_remain >
                                                0 &&
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function(response) {
                                                        if (response === 'success') {
                                                            var couponResult = document.getElementById(
                                                                "coupon-result");

                                                            couponResult.innerHTML = 'Mã giảm giá "' +
                                                                couponCode + '" đã được áp dụng thành công';
                                            ...
                                            if (couponCode == couponData[i].coupon_code) {
                                                if (couponData[i].temp_cost >= couponData[i].min_order) {
                                                    if (couponData[i].coupon_remain > 0) {
                                                        couponResult.innerHTML = 'Mã giảm giá "' + couponCode +
